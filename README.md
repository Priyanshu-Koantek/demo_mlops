...
```
mlops_stack        <- Root directory. Both monorepo and polyrepo are supported.
│
...
the [project README](./mlops_stack/README.md).
...
| Role                          | Goal                                                                         | Docs                                                                                                                                                                |
|-------------------------------|------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Data Scientist                | Get started writing ML code for a brand new project                          | [project README](./mlops_stack/README.md) |
...
| Data Scientist                | Modify production model ML resources, e.g. model training or inference jobs  | [ML resource config guide](mlops_stack/resources/README.md)  |
...
need to run it again for project `mlops_stack`.
#   d e m o _ m l o p s  
 