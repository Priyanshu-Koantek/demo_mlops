...
git add README.md docs .gitignore mlops_stack/resources/README.md
...
- **`mlops_stack-tests-ci.yml`**:<br>
  - **[CI]** Performs unit and integration tests<br>
    - Triggered on PR to main
- **`mlops_stack-bundle-cicd.yml`**:<br>
  - **[CI]** Performs validation of Databricks resources defined under `mlops_stack/resources`<br>
...
- You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-5244601605601666.6.azuredatabricks.net#setting/accounts) and
...
1. Create a new variable group called `mlops_stack variable group` defining the following secret variables, for more details [here](https://learn.microsoft.com/en-us/azure/devops/pipelines/library/variable-groups?view=azure-devops&tabs=classic#create-a-variable-group):
...
Follow the instructions in [mlops_stack/resources/README.md](../mlops_stack/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_stack/resources/README.md)  to propose, test, and deploy
