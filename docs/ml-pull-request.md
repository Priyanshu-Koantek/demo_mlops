...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/mlops_stack-tests-ci.yml) 
...
Links:
* [Staging model in UC](https://adb-5244601605601666.6.azuredatabricks.net/explore/data/models/staging/mlops_stack/mlops_stack-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/mlops_stack/mlops_stack-model)
. 
